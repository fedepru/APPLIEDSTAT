...
boxplot(tourists.mod)
tourists.mod.sd= scale(tourists.mod)

pc.touristsmod = princomp(tourists.mod.sd, scores=T)

summary(pc.touristsmod)

scores.touristsmod=pc.touristsmod$scores
scores.touristsmod


load.tourmod =pc.touristsmod$loadings
load.tourmod
